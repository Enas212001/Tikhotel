...
class AddGuestTicketItem extends Equatable {
  final int? id;
  final String? ticketId;
  final int? clientId;
  final int? departmentId;
  final dynamic problemId;
  final int? qty;
  final int? workerId;
  ...
  final dynamic closedFeedbackTime;
  final dynamic acceptedAfterClosedTime;
  final String? requestedBy;
  final dynamic requestedUser;
  final String? testing;
  final dynamic response;

  const AddGuestTicketItem({
    this.id,
    this.ticketId,
    this.clientId,
    this.departmentId,
  ...
  factory AddGuestTicketItem.fromJson(Map<String, dynamic> json) =>
      AddGuestTicketItem(
        id: json['id'] as int?,
        ticketId: json['ticket_id'] as String?,
        clientId: json['client_id'] as int?,
        departmentId: json['department_id'] as int?,
        problemId: json['problem_id'] as dynamic,
        qty: json['qty'] as int?,
        ...
        accepted: json['accepted'] as dynamic,
        ...
        closedFeedbackTime: json['ClosedFeedback_time'] as dynamic,
        acceptedAfterClosedTime: json['AcceptedAfterClosed_Time'] as dynamic,
        requestedBy: json['requested_by'] as String?,
        requestedUser: json['requestedUser'] as dynamic,

...
class S {
  ...
  String get lastReplay {
    return Intl.message('Last Replay', name: 'lastReplay', desc: '', args: []);
  }
  ...
  String get topicName {
    return Intl.message('Topic Name', name: 'topicName', desc: '', args: []);
  }
  ...
  String get topicAdded {
    return Intl.message('Topic added', name: 'topicAdded', desc: '', args: []);
  }
  ...
  String get userAdded {
    return Intl.message('User added', name: 'userAdded', desc: '', args: []);
  }
  ...
  /// `Fixed at`
  String get fixedAt {
    return Intl.message('Fixed at', name: 'fixedAt', desc: '', args: []);
  }

  /// `Dep Time at`
  String get depTimeAt {
    return Intl.message('Dep Time at', name: 'depTimeAt', desc: '', args: []);
  }
